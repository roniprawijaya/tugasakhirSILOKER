<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <?php echo form_open(base_url('/admin/keahlian/update')) ?>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 offset-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Keahlian" name="nama" class="form-control" value="<?= (set_value('nama')) ? set_value('nama') : $data->nama ?>" required>
                                </div>
                            </div>
                        </div>
                    </div>
