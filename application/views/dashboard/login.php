                    ...
                    <div class="p-3">
                        ...
                        <?php if ($this->session->userdata('success')) { ?>
                            <div class="alert alert-success" role="alert">
                                <i class="dripicons-wrong mr-2"></i> <?= $this->session->userdata('success') ?>
                            </div>
                        <?php } ?>
                        <?= form_open(base_url('/auth/validate'), 'class="mt-4"') ?>
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12 pb-3 text-center">
                                    ...
                                    <a href="<?= base_url('auth/signup')?>" class="btn btn-block btn-dark">Sign Up</a>
                                </div>
                            </div>
                        </form>
                    </div>
