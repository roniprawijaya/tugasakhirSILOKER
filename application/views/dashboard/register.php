                    ...
                    <div class="p-3">
                        ...
                        <?php if ($this->session->userdata('error')) { ?>
                            <div class="alert alert-danger" role="alert">
                                <i class="dripicons-wrong mr-2"></i> <?= $this->session->userdata('error') ?>
                            </div>
                        <?php } ?>
                        <?= form_open(base_url('/auth/register'), 'class="mt-4"') ?>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="nama">Nama</label>
                                        <input class="form-control" id="nama" type="nama" name="nama" placeholder="Nama Lengkap" value="<?= $this->session->userdata('nama') ?>" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="email">Email</label>
                                        <input class="form-control" id="email" type="email" name="email" placeholder="email@gmail.com" value="<?= $this->session->userdata('email') ?>" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12 pb-3 text-center">
                                    ...
                                    <a href="<?= base_url('auth')?>" class="btn btn-block btn-dark">Sign In</a>
                                </div>
                            </div>
                        </form>
                    </div>
