                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="<?= base_url() ?>" class="text-center">
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <!-- <img src="/assets/images/logo.jpeg" class="img-fluid" alt="homepage" class="dark-logo" /> -->
                                <!-- Light Logo icon -->
                                <img src="<?= base_url('/assets/images/logo-phk.jpeg') ?>" class="img-fluid w-50 mt-4" alt="homepage" class="light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="ml-2 d-none d-lg-inline-block"><span>Hello,</span> <span class="text-dark"><?= $this->session->userdata('username') ?></span> <i data-feather="chevron-down" class="svg-icon"></i></span>
                            </a>
